...
<body>
    <div class="container">
        ...
        <div class='d-flex mt-4 justify-content-between align-items-center'>
            <h3>Danh sách loại hàng</h3>

            <a href='' class='btn fs-5'>
                <span>Thùng rác</span>
        ...
        <div class='mt-4 d-flex align-items-center'>
            <div class='form-check'>
                ...
                <label class='form-check-label' for='check-all'>
                    Chọn tất cả (<?= count($categories)?>)
                </label>
            </div>
            <select
        ...
        <table class="table align-middle">
            <thead>
                <tr>
                    ...
                    <th scope="col" colspan="2">
                        <a class="btn btn-primary w-100" href="./category/create" role="button">
                                Thêm mới
                        </a>
                    </th>
                </tr>
            ...
            <?php foreach($categories as $category) : ?>
                    <tr>
                        ...
                        <th scope="row" width="50px"><?=$category['id']?></th>
                        <td><?=$category['name']?></td>
                        <td width="50px">
                            <a class="btn btn-success" 
                            href="./category/update?id=<?=$category['id']?>" role="button">
                                Sửa
                            </a>
                        </td>
                        <td width="50px">
                            <a class="btn btn-danger" href="./category/delete?id=<?=$category['id']?>" role="button">
                                Xóa
                            </a>
                        </td>
                    </tr>
    ...
    <script>
        ...
        checkAll.onchange = () => { 
            ...
            categoryItemCheckbox.forEach(courseItem => { 
        ...
        categoryItemCheckbox.forEach(courseItem => {
            courseItem.onchange = () => { 
                let isCheckedAll = categoryItemCheckbox.length === document.querySelectorAll('input[name="categoryIds[]"]:checked').length; 
        ...
        function renderCheckedSubmitBtn() { 
            let checkedCount = document.querySelectorAll('input[name="categoryIds[]"]:checked').length; 
