...
<body>
    <div class="container">
        ...
        <form name='form' action="../product/saveUpdate" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" step=".01" class="form-control" id="price" name="price" value="<?=$data['price']?>" required>
                <?php if(isset($_GET['error'])) : ?>
                    <p class='error text-danger mt-2 fw-bold'><?=$_GET['error']?></p>
                <?php endif ?>
            </div>
            <div class="mb-3">
                ...
                <input type="number" step="1" class="form-control" id="quantity" name="quantity" value="<?=$data['quantity']?>" required>
                <?php if(isset($_GET['error'])) : ?>
                    <p class='error text-danger mt-2 fw-bold'><?=$_GET['error']?></p>
                <?php endif ?>
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="discount" name="discount" value="<?=$data['discount']?>" required>
                <?php if(isset($_GET['error'])) : ?>
                    <p class='error text-danger mt-2 fw-bold'><?=$_GET['error']?></p>
                <?php endif ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="received_date" name="received_date" value="<?=$data['received_date']?>" required>
                <?php if(isset($_GET['error'])) : ?>
                    <p class='error text-danger mt-2 fw-bold'><?=$_GET['error']?></p>
                <?php endif ?>
            </div>
            <div class="mb-3 d-flex">
                ...
                <span class="ms-4 d-inline-flex align-items-center">
                    <input type="radio" name="special" id="no-special" value="0" <?= $data['special'] == 0 ? "checked" : ""?>>
                    <label for="no-special" class="form- mb-1 ps-1">No</label>
                </span>
                <span class="ms-4 d-inline-flex align-items-center">
                    <input type="radio" name="special" id="yes-special" value="1" <?= $data['special'] == 1 ? "checked" : ""?>>
            ...
            <div class="mb-3">
                ...
                <select class="w-100 text-center" name="category_id" id="category_id">
                    <?php foreach($categories as $category) : ?>
                        <option value="<?=$category['id']?>" <?= $category['id'] == $data['category_id'] ? "selected=selected" : ""?>
                        >
                            <?=$category['name']?>
                        </option>
                    <?php endforeach ?>
